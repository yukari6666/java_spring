...
<link href="${pageContext.request.contextPath}/resources/input.css" rel="stylesheet" />
</head>
<body>
<!-- <a href="/game">목록으로</a> -->
	<form action="input_data" method="get">
		<label>ID</label> <input type="text" placeholder="아이디 입력" name="id" />
		<label>PASS</label> <input type="password" placeholder="비밀번호" name="pass" />
